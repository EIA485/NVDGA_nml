...
namespace NVDGA
{
	public class NVDGA : NeosMod
	{
		public override string Name => "NVDGA";
		public override string Author => "KirillianAmu, eia485";
		public override string Version => "1.0.0";
		public override string Link => "https://github.com/EIA485/NVDGA_nml";
        ...
        public override void OnEngineInit()
        {
            ...
            Msg("Dynamic Visuals Adjuster is starting.");
            Msg("Min reprojection frames are set to: " + fMinReprojectionValue.ToString() + " frames.");
            Msg("Desired max framerate is set to: " + fTargetFramerate.ToString() + " frames.");
            ...
            Msg("\n\n!!!Warning!!!: " +
                "\n\nNeos will likely change it's renderer eventually, making this mod OBSOLETE!!! " +
            ...
            Harmony harmony = new Harmony("net.eia485.NVDGA");
            harmony.PatchAll();
        }
        ...
        void ChangeSettingsPotato()
        {
            ...
            Msg("MAJOR instability detected. Keeping last good framerate setting and increasing wait time...");
            flTimer = 30.0f;
            flInstabilityTimer = 30.0f;
            Msg("Emergency Settings to prevent motion sickness in any possible way.");
        ...
        {
            Msg("Low quality settings, your framerate might've dipped.");
            QualitySettings.SetQualityLevel(0);
        ...
        {
            Msg("Normal quality settings, your framerate might've dipped.");
        ...
        [HarmonyPostfix]
        [HarmonyPatch(typeof(Engine), "RunUpdateLoop")]
        public void OnUpdate()
        {
            ...
            if (flInstabilityTimer <= 0)
            {
                ...
                if (iHowMany != 0)
                {
                    if (bRetainReprojection == false)
                    {
                        Msg(iHowMany.ToString() + "0% instability.");
                    }
                    else Msg(iHowMany.ToString() + "0% reprojection mode.");
                }
            ...
            if (flTimer <= 0)
            {
                ...
                if (iHowMany > 4)
                {
                    Msg("Minor Instability detected.");
                    ChangeSettings();
                }
